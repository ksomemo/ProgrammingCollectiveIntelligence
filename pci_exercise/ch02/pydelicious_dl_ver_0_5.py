...
__description__ = '''pydelicious_dl_ver_0_5.py allows you to access the web service of del.icio.us via it's API through python.'''
...
USER_AGENT = 'pydelicious_dl_ver_0_5.py/%s %s' % (__version__, __url__)
